#q1
# Roll 12 dice simultaneously, and let X denotes the number of 6’s that appear. Calculate the probability of getting 7, 8 or 9, 6’s using R.
#(Try using the function pbinom;If we set S = {get a 6 on one roll}, P(S) = 1/6 and the rolls constitute Bernoulli trials;
...
#Next, suppose the car wash above is in operation from 8AM to 6PM, and we let Y be the number of customers that
